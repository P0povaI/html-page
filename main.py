...
if __name__ == "__main__":
    ...
    while True:
        if story.current_chapter > len(story.chapters):
            ...
            while enemy.health > 0:
                ...
                if enemy.health > 0:
                    ...
                    print(
                        f"|- The enemy deals {enemy_damage} damage. Your health is {p1.health}\n|"
                    )
                    if p1.health <= 0:
                        print("😵 You died!")
        ...
        if current_room == "Casino":
            ...
            if p1.coins < 1:
                print(
                    "You don't have enough money to bet! You continue to the next room."
                )
            else:
                ...
                if bet == 0:
                    ...
                    while bet > p1.coins:
                        print(
                            f"You only have {p1.coins} coins. Enter a smaller amount."
                        )
                        bet = int(input("Enter your choice: "))
            ...
            print(
                f"🧡 Health: {p1.health} 🧠 Experience: {p1.experience} 💰 Player coins: {p1.coins}"
            )
            print("-------------------------------\n")
            ...
            if p1.coins < 5:
                print(
                    "You don't have enough money to sleep! You continue to the next room."
                )
            else:
            ...
            print("------------ Chest ------------\n")
            print(
                "🤔 You entered a room and found a misterious chest. Do you want to open it?"
            )
            ...
            if choice == "o":
                ...
                if current_chest == "Health potion":
                    ...
                    if p1.health >= p1.max_health:
                        p1.health = p1.max_health
                    print(
                        f"|🧪 You found a health potion. {p1.health-last_health} health added.\n"
                    )
                ...
                print(
                    "You decided not to open the chest and continue to the next room!\n"
                )
            ...
            if enemy_type == "enemy":
                ...
                if enemy_class == "mage":
                    print(
                        "🧙🏻‍♀️ You entered a room and there is an enemy that attacks you!\n"
                    )

                elif enemy_class == "fighter":
                    print(
                        "🥷🏻 You entered a room and there is an enemy that attacks you!\n"
                    )

            else:
                print(
                    "🐲 You entered a room and there is a giant, powerful enemy waiting for you!\n"
                )
                ...
                while enemy.health > 0:
                    ...
                    if enemy.health > 0:
                        ...
                        if p1.health <= 0:
                            print("😵 You died!")
                            print(
                                f"🎓 Player level: {p1.level} 🗡️ Player kills: {p1.kills}"
                            )
                            exit()
                    else:
                        print("\nYou killed the enemy!\n")
            ...
            print(
                f"🧡 Player health: {p1.health} 🧠 Player experience: {p1.experience} 💰 Player coins: {p1.coins}"
            )
            print("-------------------------------\n")
            ...
            if p1.coins < 15:
                ...
                print(
                    "🤔 You can update your damage or health. You can also buy the legendary Charm of Purity that grants the wearer the power to break free from any curse or The Hemostatic Bandage that quickly staunches bleeding, sealing wounds with its specially treated fabric. "
                )
                ...
                if item == "d":
                    ...
                    p1.coins -= 15
                    print(
                        f"|🗡️ You spent 15 coins and your damage increased to: {p1.damage}\n"
                    )
                elif item == "h":
                    p1.max_health += 2
                    p1.coins -= 15
                    print(
                        f"|🧡 You spent 15 coins and your maximum health increased to: {p1.max_health}\n"
                    )
                elif item == "c":
                    p1.coins -= 2
